...
func (v *ModelServingValidator) validateModelServing(modelServing *workloadv1alpha1.ModelServing) (bool, string) {
	return v.validateModelServingErrors(modelServing, nil)
}
...
func (v *ModelServingValidator) validateModelServingUpdate(oldModelServing, modelServing *workloadv1alpha1.ModelServing) (bool, string) {
	return v.validateModelServingErrors(modelServing, validateNetworkTopologyImmutable(oldModelServing, modelServing))
}

func (v *ModelServingValidator) validateModelServingErrors(modelServing *workloadv1alpha1.ModelServing, allErrs field.ErrorList) (bool, string) {
