...
func TestUpdatePodGroupTopologyAffinity(t *testing.T) {
	...
	ms := &workloadv1alpha1.ModelServing{
		...
		Spec: workloadv1alpha1.ModelServingSpec{SchedulerName: "volcano", Template: workloadv1alpha1.ServingGroup{
			Roles: []workloadv1alpha1.Role{{Name: "role0", Replicas: ptr.To[int32](1), EntryTemplate: workloadv1alpha1.PodTemplateSpec{Spec: corev1.PodSpec{Containers: []corev1.Container{{Name: "c", Image: "img"}}}}}},
		}},
	}
	ms.Spec.Template.NetworkTopology = &workloadv1alpha1.NetworkTopology{
		ServingGroupAntiAffinity: &workloadv1alpha1.ServingGroupAntiAffinity{
