...
// TestScalingScenarios runs all scaling test cases from YAML files.
func TestScalingScenarios(t *testing.T) {
	testCasesDir := filepath.Join("testcases", "scaling")
...
// TestServingGroupScale tests ServingGroup replica scaling.
func TestServingGroupScale(t *testing.T) {
	testCasePath := filepath.Join("testcases", "scaling", "01_servinggroup_scale.yaml")
...
// TestRoleScale tests Role replica scaling.
func TestRoleScale(t *testing.T) {
	testCasePath := filepath.Join("testcases", "scaling", "02_role_scale.yaml")
...
// TestWorkerScale tests Worker replica scaling.
func TestWorkerScale(t *testing.T) {
	testCasePath := filepath.Join("testcases", "scaling", "03_worker_scale.yaml")
